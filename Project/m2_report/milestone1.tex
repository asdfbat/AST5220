...
The Saha equation \ref{eqn:Saha} is actually analytically solvable. Multiplying by $(1-X_e)$ on both sides gives us
\begin{equation*}
    X_e^2 = (1-X_e)A \quad \Rightarrow \quad X_e^2 + AX_e - A = 0
\end{equation*}
